...
router.post('/', requireJwt, requireAdmin, MovieController.createMovie);
//http://localhost:3000/api/v2/movies/68f5a3e17aafa400bea086ef -- { "durationMin": 60 }
router.patch('/:id', requireJwt, requireAdmin, MovieController.updateMovie);
//http://localhost:3000/api/v2/movies/68f5a3e17aafa400bea086ef
router.delete('/:id', requireJwt, requireAdmin, MovieController.deleteMovie);
